...
public:
    ...
    virtual void processImage(const cv::Mat &inputImage, cv::Mat &outputImage, std::vector<cv::Rect> &object) = 0;
};

#define CVPLUGININTERFACE_IID "com.life.cvplugininterface"
